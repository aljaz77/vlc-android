...
@JvmField val CUSTOM_ACTION_NORMALIZATION = "normalization".buildPkgString()
...
enum class NotificationIds(val id: Int) {
    MEDIA_PARSING(43), PLAYBACK(3), DEBUG_LOGS(46), REMOTE_ACCESS(44), REMOTE_ACCESS_OTP(45), RECOMMENDATIONS(47), LOUDNESS_ANALYSIS(48)
}