...
@Database(entities = [ExternalSub::class, Slave::class, BrowserFav::class, CustomDirectory::class, Widget::class, EqualizerBand::class, EqualizerEntry::class, TrackLoudness::class], version = 38, exportSchema = false)
...
abstract class MediaDatabase: RoomDatabase() {
    ...
    abstract fun trackLoudnessDao(): TrackLoudnessDao
